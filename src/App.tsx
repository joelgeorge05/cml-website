...
export default function App() {
 ...
 supabase.from('units').select('id, name, patron_saint, contact_number, bg_photo, order_index, director_name, director_phone, joint_director_name, joint_director_phone, president_name, president_phone, stats_members, stats_families, stats_directors_count, description').order('order_index'),
 ...
 jointDirectorName: u.joint_director_name || localExec.jointDirectorName,
 jointDirectorPhone: u.joint_director_phone || localExec.jointDirectorPhone,
 directorName: u.director_name || localExec.directorName,
 directorPhone: u.director_phone || localExec.directorPhone,
 presidentName: u.president_name || localExec.presidentName,
 presidentPhone: u.president_phone || localExec.presidentPhone,
 stats: { 
