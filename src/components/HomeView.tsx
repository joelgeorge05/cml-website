...
import asstDirectorImg from '../assets/images/assistant Director.jpeg';
import presidentImg from '../assets/images/Preseident.jpeg';

import thereseImg from '../assets/images/st_therese.png';

import reloopVideo from '../assets/images/reloop video.mp4';
import halfYearlyCouncilImg from '../assets/images/half yearly council.jpeg';
import chosen2Img from '../assets/images/chosen 2.jpeg';
import orphanageImg from '../assets/images/Orphange visit.jpeg';
import chosen3Img from '../assets/images/chosen 3.jpeg';
import alterBoysImg from '../assets/images/alter boys meeting.jpeg';
...
export default function HomeView({
      ...
      <div className="bg-white/80 backdrop-blur-md border border-amber-500/30 rounded-[24px] px-5 py-4 shadow-[0_12px_40px_rgba(244,63,94,0.06),inset_0_1px_1px_rgba(255,255,255,0.6)] flex flex-row items-center justify-start gap-4 transform transition-all duration-300 hover:shadow-[0_16px_50px_rgba(244,63,94,0.12)] hover:border-amber-500/55 hover:-translate-y-0.5 cursor-default group relative overflow-hidden">
        ...
        <div className="flex flex-col items-start flex-1 min-w-0 z-10">
          ...
          <span className="font-malayalam font-extrabold text-[16px] sm:text-[18px] text-stone-900 leading-snug w-full whitespace-normal drop-shadow-xs">
            സഭയ�  സ്ന�!ഹി�"്�"ാ� ല�9�"ത്തിൽ സാ�"്ഷി�"ളാ�"ാ�
          </span>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="w-full bg-[#fdfbf7] text-stone-800 relative pb-20 overflow-hidden font-sans">
      ...
      {/* Hero Section */}
      <section className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-2 sm:pt-3 pb-2 min-h-[calc(100vh-260px)] flex flex-col z-10">
            ...
            <div className="flex flex-col items-center gap-2 w-full">
              ...
              <div className="flex flex-col items-center gap-3 w-full">
                ...
                <div className="relative group w-full max-w-[96%] mx-auto mt-1 mb-1">
                  ...
                  <div className="relative bg-white/70 backdrop-blur-xl border border-stone-200/80 shadow-[0_8px_32px_rgba(0,0,0,0.04)] rounded-[2rem] p-3 xs:p-4 sm:p-5 flex flex-col items-center gap-3 sm:gap-4 overflow-hidden transition-all duration-300 group-hover:shadow-[0_12px_40px_rgba(0,0,0,0.06)] group-hover:border-stone-300/60">
                    ...
                    <div className="flex flex-col gap-2 sm:gap-3 select-none font-malayalam leading-tight relative z-10 w-full">
                      {/* Line 1: സ� ന�!ഹ� �  ത� യാ�� */}
                      <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-x-4 sm:gap-x-6 w-full max-w-[420px] xl:max-w-[480px] mx-auto">
                        <span className="text-stone-900 font-bold text-[36px] xs:text-[42px] sm:text-[48px] lg:text-[42px] xl:text-[52px] tracking-normal drop-shadow-sm transition-transform duration-300 group-hover:scale-[1.02] text-right leading-tight">
                          സ� ന�!ഹ�
                        </span>
                        ...
                        <span className="text-stone-900 font-bold text-[36px] xs:text-[42px] sm:text-[48px] lg:text-[42px] xl:text-[52px] tracking-normal drop-shadow-sm transition-transform duration-300 group-hover:scale-[1.02] text-left leading-tight">
                          ത� യാ��
                        </span>
                      </div>
                      ...
                      <div className="flex items-center justify-center w-full opacity-50 my-0.5">
                         <div className="h-[1.5px] w-full max-w-[180px] sm:max-w-[200px] bg-gradient-to-r from-transparent via-stone-300 to-transparent" />
                      </div>

                      {/* Line 2: സ�!വന� �� സഹന� */}
                      <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-x-4 sm:gap-x-6 w-full max-w-[420px] xl:max-w-[480px] mx-auto">
                        <span className="text-[#f43f5e] font-bold text-[36px] xs:text-[42px] sm:text-[48px] lg:text-[42px] xl:text-[52px] tracking-normal drop-shadow-sm transition-transform duration-300 group-hover:scale-[1.02] text-right leading-tight">
                          സ�!വന�
                        </span>
                        {/* Decorative Separator Column */}
                        <div className="flex flex-col items-center justify-center gap-1 opacity-90">
                        ...
                        <span className="text-[#f59e0b] font-bold text-[36px] xs:text-[42px] sm:text-[48px] lg:text-[42px] xl:text-[52px] tracking-normal drop-shadow-sm transition-transform duration-300 group-hover:scale-[1.02] text-left leading-tight">
                          സഹന�
                        </span>
                      </div>
                    </div>
              ...
              <div className="flex flex-col gap-2 mt-0 w-full items-center select-none font-sans">
                ...
                >
                  ...
                  <div className="w-[20px] h-[34px] rounded-full border-[1.5px] border-stone-400/60 flex justify-center pt-1.5 relative shadow-sm backdrop-blur-sm bg-white/30">
            ...
            <div className="relative w-full aspect-[4/3] sm:aspect-[1.4] md:aspect-[1.5] lg:aspect-[1.62] xl:aspect-[1.65] border-[3.5px] border-yellow-400 bg-white/60 backdrop-blur-md p-1 rounded-[32px] shadow-[0_20px_50px_rgba(0,0,0,0.08)] hover:scale-[1.01] hover:border-yellow-500 hover:shadow-[0_25px_60px_rgba(234,179,8,0.15)] transition-all duration-500 ease-out z-10 group/hero-frame">
              ...
              <div className="w-full h-full rounded-[26px] overflow-hidden bg-stone-950 relative border border-yellow-500/35">
                ...
                <div className="absolute bottom-9 left-1/2 -translate-x-1/2 w-max max-w-[90%] z-20 select-none">
                  <div className="group relative overflow-hidden rounded-xl bg-black/30 backdrop-blur-md border border-white/10 shadow-2xl px-2.5 sm:px-4 py-1.5 sm:py-2 flex items-center justify-between gap-2 sm:gap-6 transition-all duration-500 hover:bg-black/40 hover:border-white/30">
                    ...
                    <div className="shrink-0 flex flex-col items-end gap-1 relative z-10 border-l border-white/10 pl-2">
                      <div className="flex items-center justify-center px-1.5 py-1 rounded-md bg-white/5 border border-white/10 backdrop-blur-sm">
      ...
      <section className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-8 lg:pt-16 lg:pb-12 z-10 relative">
        <div className="flex flex-col gap-8 lg:gap-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {/* Director's Message (സന്ദ�!ശ�) */}
            <div 
              className="bg-white/80 backdrop-blur-xl rounded-[2.5rem] p-7 sm:p-9 border-[1.5px] border-stone-200/50 shadow-sm hover:shadow-[0_20px_40px_-15px_rgba(245,158,11,0.15)] hover:border-amber-300/60 transition-all duration-500 flex flex-col relative group overflow-hidden cursor-pointer"
            ...
            {/* Assistant Director's Message (� ശ�സ) */}
            <div 
              className="bg-white/80 backdrop-blur-xl rounded-[2.5rem] p-7 sm:p-9 border-[1.5px] border-stone-200/50 shadow-sm hover:shadow-[0_20px_40px_-15px_rgba(244,63,94,0.15)] hover:border-rose-300/60 transition-all duration-500 flex flex-col relative group overflow-hidden cursor-pointer"
            ...
            {/* President's Message (� മു��) */}
            <div 
              className="bg-white/80 backdrop-blur-xl rounded-[2.5rem] p-7 sm:p-9 border-[1.5px] border-stone-200/50 shadow-sm hover:shadow-[0_20px_40px_-15px_rgba(99,102,241,0.15)] hover:border-indigo-300/60 transition-all duration-500 flex flex-col relative group overflow-hidden cursor-pointer md:col-span-2 lg:col-span-1"
