...
export default function ImageCropperModal({
 ...
 const maxSize = aspectRatio === 1 ? 300 : 800;
 const croppedBlob = await getCroppedImg(imageSrc, croppedAreaPixels, 0, { horizontal: false, vertical: false }, maxSize);
 if (croppedBlob) {
 ...
 animate={{ opacity: 1 }}
 exit={{ opacity: 0 }}
 className="fixed inset-0 z-[100] flex items-center justify-center bg-stone-900/80 p-4"
 >
 <motion.div
