              ...
              <AnimatePresence mode="wait">
                {!dbData?.settings?.showOverallLeaderboard && !isAdminLoggedIn ? (
                  <motion.div
                     ...
                     className="relative flex flex-col items-center justify-center p-12 mt-4 z-10 bg-white/70 backdrop-blur-xl rounded-3xl border border-white/50 shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden group"
                  >
