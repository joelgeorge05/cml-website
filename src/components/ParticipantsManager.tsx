...
export default function ParticipantsManager({ dbData, currentUser, onSaveDatabase, triggerToast }: ParticipantsManagerProps) {
  ...
  return (
    <div className="flex flex-col gap-6 animate-fade-in text-left">
      ...
      {/* Tab Banner */}
      <div className="flex flex-col md:flex-row md:items-center justify-between border-b border-slate-200 pb-5 gap-4 sticky top-0 z-30 bg-white/90 backdrop-blur-xl pt-4 shadow-sm -mt-4 px-2 rounded-b-2xl">
