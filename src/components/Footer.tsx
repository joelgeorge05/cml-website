      ...
      <div className="w-full max-w-7xl mx-auto px-4 md:px-6 py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div className="flex flex-col gap-4 text-left">
          ...
          <div className="flex items-center gap-3 text-slate-400 text-xs font-semibold pt-1">
            ...
            <span>Motto: Love â€¢ Sacrifice â€¢ Service â€¢ Suffering</span>
          </div>
          {/* Social Media Links */}
          ...
          <ul className="flex flex-col gap-2 text-xs">
            ...
            <li>
              <button onClick={() => { setActiveTab('kalolsavam'); window.scrollTo({ top: 0, behavior: 'smooth' }); }} className="hover:text-rose-400 transition flex items-center gap-1.5 text-amber-400 hover:text-amber-300">
                <Calendar className="w-3 h-3" /> Mekhala Kalolsavam 2026â€“27
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6 text-xs text-slate-500">
          ...
          <div className="flex flex-col gap-2.5 text-center md:text-left max-w-xl">
            <p className="text-slate-400 leading-relaxed">
              Â© 2026 Cherupushpa Mission League Kaliyar Mekhala.
          ...
          <div className="flex flex-col items-center md:items-end gap-2 shrink-0">
            <div className="flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-gradient-to-r from-amber-500/5 via-slate-900/75 to-amber-500/5 border border-amber-500/25 shadow-[0_0_12px_rgba(245,158,11,0.06)] relative overflow-hidden group select-none backdrop-blur-md">
