...
import cmlFlagImg from '../assets/images/flag.webp';
import cmlEmblemImg from '../assets/images/logo.webp';
...
export default function HistoryView() {
 ...
 <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/80 border border-rose-100 text-[#be123c] text-[10px] font-black tracking-widest uppercase rounded-full shadow-sm animate-fade-in select-none">
 ...
 <span className="text-[9px] font-mono font-black tracking-widest text-[#be123c] bg-white/95 py-1 px-3 rounded-full shadow-md border border-[#be123c]/20 uppercase">
 ...
 <div className="flex bg-white/60 p-1 rounded-full border border-slate-200/60 shadow-sm">
 <button
 ...
 {/* Malayalam Card */}
 <div className={`bg-white/80 rounded-3xl p-6 sm:p-8 border border-white/60 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_30px_-4px_rgba(0,0,0,0.08)] transition-all duration-300 ${activeLyric === 'malayalam' ? 'block' : 'hidden lg:block'}`}>
 ...
 style={{ fontFamily: "'Noto Serif Malayalam', 'Manjari', serif" }}
 >
 <p>ഭാരതമേ! നിൻ രക്ഷ നിൻ മക്കളിൽ</p>
 <p>ഹർഷ പൂർണ്ണമേ! നിൻ ശാന്തി നിൻ തേൻകളിൽ</p>
 <p>സുന്ദരരേ! കൈകൾ ഉർത്ത് മുന്നേറുവിൻ</p>
 <p>സത്യ കാഹളം മുഴക്കി മുന്നേറുവിൻ</p>
 <p className="pt-2 text-slate-600">നാം ഒന്നിച്ചൊരേ കൈകൾ പിടിക്കൂ കേൾക്കൂ</p>
 <p className="text-slate-600">ക്രിസ്തുവിനായ് പണിയൂ കൂടേ കേൾക്കൂ</p>
 <p className="text-slate-600">വയലുകൾ വിളഞ്ഞ വയലുകൾ</p>
 <p className="text-slate-600">വിളവ് കൂടുവാൻ നാം കൈ കൂടി നിരക്കുന്നു</p>
 <p className="pt-2 text-slate-600">സ്നേഹവും ത്യാഗവും നുകർന്ന് നാം</p>
 <p className="text-slate-600">സേവനത്തിന ദൂതരായി വരുന്നിതാ</p>
 <p className="text-slate-600">കരകൾ തിരകൾ കടന്ന് നാം</p>
 <p className="text-slate-600">സുവിശേഷ ദൂതരായ് വരുന്നിതാ</p>
 <p className="pt-2">ഭാരതമേ! നിൻ രക്ഷ നിൻ മക്കളിൽ</p>
 <p>ഹർഷ പൂർണ്ണമേ! നിൻ ശാന്തി നിൻ തേൻകളിൽ</p>
 <p>സുന്ദരരേ! കൈകൾ ഉർത്ത് മുന്നേറുവിൻ</p>
 <p>സത്യ കാഹളം മുഴക്കി മുന്നേറുവിൻ</p>
 <div className="mt-4 p-4 rounded-xl bg-amber-50/50 border border-amber-100/50 text-center">
 <p className="text-rose-700 font-black text-lg">മുന്നേറുവിൻ</p>
 <p className="text-rose-700 font-black text-lg">മുന്നേറുവിൻ</p>
 </div>
 </div>
 </div>
 ...
 {/* Manglish Card */}
 <div className={`bg-white/80 rounded-3xl p-6 sm:p-8 border border-white/60 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_30px_-4px_rgba(0,0,0,0.08)] transition-all duration-300 ${activeLyric === 'manglish' ? 'block' : 'hidden lg:block'}`}>
