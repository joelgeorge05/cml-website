...
export default function EventsView({ events }: EventsViewProps) {
 ...
 />
 <div className="absolute top-4 left-4 bg-slate-950/85 text-amber-400 font-mono text-[9px] font-bold px-2 py-1 rounded tracking-wide uppercase border border-slate-800 z-20 shadow">
